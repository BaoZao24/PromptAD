...
class ResidualAttentionBlock(nn.Module):
    ...
    def attention(
        ...
        self.attn_mask = attn_mask.to(q_x.dtype) if attn_mask is not None else None
    ...
    def __init__(
        ...
        self.resblocks = nn.ModuleList([
            ResidualAttentionBlock(
                width, heads, mlp_ratio, ls_init_value=ls_init_value, act_layer=act_layer, norm_layer=norm_layer, idx=idx)
...
class V2VTransformer(nn.Module):
    output_tokens: torch.jit.Final[bool]
