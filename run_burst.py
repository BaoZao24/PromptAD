"""
批量运行 burst_signal 实验（所有场景 + 指定噪声级别），包含可视化

用法:
    python run_burst.py --noise-level m30db --k-shot 4
    python run_burst.py --noise-level m30db --k-shot 4 --epochs 100
    python run_burst.py --all-jsr --k-shot 4  # 运行所有 JSR 级别
"""
import argparse
import subprocess
import os
...
if __name__ == '__main__':
    ...
    for noise_level in noise_levels:
        ...
        for scene in SCENES:
            cmd = (
                f'python train_cls.py --dataset burst_signal --class_name {scene} '
